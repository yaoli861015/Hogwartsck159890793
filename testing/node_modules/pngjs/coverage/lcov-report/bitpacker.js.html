...
module.exports = function (dataIn, width, height, options) {
  ...
  <span class="missing-if-branch" title="else path not taken">E</span>if (options.colorType === options.inputColorType) {
    ...
    <span class="missing-if-branch" title="else path not taken">E</span>if (options.bitDepth === 8 || (<span
            class="branch-1 cbranch-no" title="branch not covered">options.bitDepth === 16 </span>&amp;&amp; <span
            class="branch-2 cbranch-no" title="branch not covered">bigEndian)</span>) {
      return dataIn;
    }
  }
&nbsp;
...
<span class="cstat-no" title="statement not covered">    inBpp = 3;</span>
  ...
  let outBpp = <span class="cstat-no"
                     title="statement not covered">constants.COLORTYPE_TO_BPP_MAP[options.colorType];</span>
...
<span class="cstat-no"
      title="statement not covered">    return { red: red, green: green, blue: blue, alpha: alpha };</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered">  for (let y = <span class="cstat-no"
                                                                          title="statement not covered">0;</span> y &lt; height; y++) {</span>
<span class="cstat-no" title="statement not covered">    for (let x = <span class="cstat-no"
                                                                            title="statement not covered">0;</span> x &lt; width; x++) {</span>
...
<span class="cstat-no" title="statement not covered">            if (outHasAlpha) {</span>
<span class="cstat-no"
      title="statement not covered">              outData.writeUInt16BE(rgba.alpha, outIndex + 6);</span>
            }
          }
<span class="cstat-no" title="statement not covered">          break;</span>
        case constants.COLORTYPE_ALPHA:
        case constants.COLORTYPE_GRAYSCALE: {
          ...
          let grayscale = <span class="cstat-no"
                                title="statement not covered">(rgba.red + rgba.green + rgba.blue) / 3;</span>
<span class="cstat-no" title="statement not covered">          if (options.bitDepth === 8) {</span>
...
<span class="cstat-no" title="statement not covered">            if (outHasAlpha) {</span>
<span class="cstat-no"
      title="statement not covered">              outData.writeUInt16BE(rgba.alpha, outIndex + 2);</span>
            }
          }
<span class="cstat-no" title="statement not covered">          break;</span>
        }
